...
class Unet(nn.Module):
    def __init__(self, num_classes = 21, pretrained = False, backbone = 'vgg',phi=0):
        ...
        self.phi=phi
        if phi>=1 and phi<=3:
            self.feat1_attention=attention_blocks[phi-2](64)
            self.feat2_attention = attention_blocks[phi - 2](128)
            self.feat3_attention = attention_blocks[phi - 2](256)
            self.feat4_attention = attention_blocks[phi - 2](512)
            self.feat5_attention = attention_blocks[phi - 3](64)
        # upsampling
        # 64,64,512
